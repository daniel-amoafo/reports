...
//
//    init(currency: Currency, locale: Locale) {
//        super.init()
//        self.locale = locale
...
//    private static var formatters: [String: CurrencyFormatter] = [:]
//
//    static func formatter(for currency: Currency, locale: Locale) -> CurrencyFormatter {
//        let key = "\(currency.code)-\(locale.identifier)"
//        if let formatter = formatters[key] {
//            return formatter
//        }
//
//        let newFormatter = CurrencyFormatter(currency: currency, locale: locale)
